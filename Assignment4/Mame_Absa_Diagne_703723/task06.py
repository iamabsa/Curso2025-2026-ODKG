...
# %%
g.add((Os, RDF.type, ontology.AssociateProfessor))
g.add((Os, RDFS.label, Literal("Oscar", datatype=XSD.string)))
g.add((Os, ontology.hasColleague, As))
g.add((Os, ontology.hasName, Literal("Oscar", datatype=XSD.string)))

g.add((As, RDF.type, ontology.FullProfessor))
g.add((As, RDFS.label, Literal("Asun", datatype=XSD.string)))
g.add((As, ontology.hasColleague, Ra))
g.add((As, ontology.hasHomePage, Literal("https://asun.homepage", datatype=XSD.string)))

g.add((Ra, RDF.type, ontology.InterimAssociateProfessor))
g.add((Ra, RDFS.label, Literal("Raul", datatype=XSD.string)))
...
# %%
#we need VCARD and FOAF
VCARD = Namespace("http://www.w3.org/2001/vcard-rdf/3.0/")
FOAF  = Namespace("http://xmlns.com/foaf/0.1/")

# %%
g.add((Os, VCARD.Family, Literal("Oscae", datatype=XSD.string)))
g.add((Os, VCARD.Given, Literal("Corcho", datatype=XSD.string)))
g.add((Os, FOAF.email, Literal("os.co@upm.es", datatype=XSD.string)))
